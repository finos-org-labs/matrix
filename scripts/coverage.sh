...
echo "============================================================"
echo "finkit-matrix Coverage Report Generator"
echo "============================================================"
echo ""
...
cmake --build . --target matrix_tests --parallel

# Check if test binary exists
if [ ! -f "./tests/matrix_tests" ]; then
    echo "Error: Test binary not found at ./tests/matrix_tests"
    exit 1
fi
